...
pub use application::{
    ...
    ClaimRepository, ClusterDetectionUseCase, CommunityNamingUseCase, ContextNode,
    CouplingDetectionUseCase, DeleteRepositoryUseCase, DreamReport, EmbeddingService,
